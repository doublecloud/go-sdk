...
func (c *UserServiceClient) Create(ctx context.Context, in *kafka.CreateUserRequest, opts ...grpc.CallOption) (*doublecloud.Operation, error) {
...
func (c *UserServiceClient) Delete(ctx context.Context, in *kafka.DeleteUserRequest, opts ...grpc.CallOption) (*doublecloud.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *UserServiceClient) GrantPermission(ctx context.Context, in *kafka.GrantUserPermissionRequest, opts ...grpc.CallOption) (*doublecloud.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *UserServiceClient) RevokePermission(ctx context.Context, in *kafka.RevokeUserPermissionRequest, opts ...grpc.CallOption) (*doublecloud.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *UserServiceClient) Update(ctx context.Context, in *kafka.UpdateUserRequest, opts ...grpc.CallOption) (*doublecloud.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
